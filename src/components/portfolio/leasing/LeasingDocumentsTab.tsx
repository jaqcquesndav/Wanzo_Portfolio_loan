// src/components/portfolio/leasing/LeasingDocumentsTab.tsx
...
interface LeasingDocumentsTabProps {
  portfolioId: string;
}

export function LeasingDocumentsTab({ portfolioId }: LeasingDocumentsTabProps) {
