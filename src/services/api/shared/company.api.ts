...
export const companyApi = {
  ...
  /**
   * Recherche des entreprises par terme — wrapper autour de getAllCompanies
   */
  searchCompanies: (searchTerm: string, filters?: Omit<ProspectionFilters, 'searchTerm'>) => {
    return companyApi.getAllCompanies({ ...filters, searchTerm });
  },
