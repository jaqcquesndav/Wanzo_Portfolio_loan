/**
 * Définitions de types pour les services de stockage
 * 
 * Ce fichier centralise tous les types utilisés par les services de stockage,
 * ce qui permet d'assurer la cohérence des données manipulées par ces services.
 */
