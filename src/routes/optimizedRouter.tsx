  ...
  return createBrowserRouter([
    ...
    // Routes principales de l'application
    {
      ...
      children: [
        ...
        { path: 'equipments/:equipmentId', element: <components.LeasingEquipmentDetail />, errorElement: <components.PortfolioErrorBoundary /> },
        { path: 'contracts/:contractId', element: <components.LeasingContractDetail />, errorElement: <components.PortfolioErrorBoundary /> },
        { path: 'incidents/:incidentId', element: <components.LeasingIncidentDetail />, errorElement: <components.PortfolioErrorBoundary /> },
        { path: 'maintenance/:maintenanceId', element: <components.LeasingMaintenanceDetail />, errorElement: <components.PortfolioErrorBoundary /> },
